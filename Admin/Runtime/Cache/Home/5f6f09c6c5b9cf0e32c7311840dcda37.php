            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="#"><i class="fa fa-gear fa-fw"></i> 密码管理</a>
                        </li>
                        <li class="divider"></li>
             ...
             <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="<?php echo U('hospital/index');?>"><i class="fa fa-wrench fa-fw"></i> 医院管理<span class="fa arrow"></span></a>
                        </li>
                        <li>
                            <a href="<?php echo U('engineers/index');?>"><i class="fa fa-wrench fa-fw"></i> 工程师管理<span class="fa arrow"></span></a>
                        </li>
                        <li>
                            <a href="<?php echo U('order/index');?>"><i class="fa fa-wrench fa-fw"></i> 工单管理<span class="fa arrow"></span></a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i> 基础数据管理<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="<?php echo U('user/admin_index');?>"><i class="fa fa-sitemap fa-fw"></i> 管理员维护<span class="fa arrow"></span></a>
                            <!-- /.nav-second-level -->
                        </li>
            ...
            <div class="row">
                <div style="text-align:left" class="col-lg-12 m-b-xs">
                    <form class="form-inline" role="form" method="post">
                        <input type="hidden" id="out_g_order_action_url" value="<?php echo U('hospital/daochu');?>">
                        <input type="hidden" id="search_g_order_action_url" value="<?php echo U('hospital/index');?>">
                        <div>
                            <div class="form-group ">医院编号:&nbsp;<input type="text" name="code" value="<?php echo ($post["code"]); ?>" class="form-control" placeholder="单行输入"></div>
                        </div>
                        <div>
                            <div class="form-group">医院名称:&nbsp;<input type="text" name="name" value="<?php echo ($post["name"]); ?>" class="form-control" placeholder="客户名称" name="customer_name"></div>
                        </div>
                        <div>
                    ...
                    $("#areainfo").html(msg);
                        ...
                        <div class="form-group ">状态:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <select name="status" class="form-control">
                                ...
                                <option value="0" <?php if($post['status'] != '' && $post['status'] == 0): ?>selected<?php endif; ?>>待施工</option>
                            </select>
                        </div>
                        <div class="form-group"><button class="btn btn-sm" id="add_g_order"><a href="<?php echo U('hospital/add');?>">新增</a></button></div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): foreach($list as $k=>$data): ?><tr class="gradeA">
                                                ...
                                                <td><?php echo ($data["menzhennum"]); ?></td>
                                                <td><?php echo ($data["bednum"]); ?></td>
                                                <td><?php echo ($data["contactname"]); ?></td>
                                                <td><?php echo ($data["contacttel"]); ?></td>
                                                <td><?php if($data['status'] == 1): ?>已上线<?php else: ?>待施工<?php endif; ?></td>
                                                <td><?php echo ($data["memo"]); ?></td>
                                                <td><a href="<?php echo U('hospital/add',array('id'=>$data['id'],'edit_info'=>'修改信息'));?>">修改</a></td>

...
<title>登录</title>
<style>
 body{padding:0px; margin:0px; font-size:14px; color:#fff; line-height:24px; font-family:"Microsoft Yahei", "Arial Unicode MS"; background:url(/order/order/Public/images/background.jpg) ;}
...
<script language="JavaScript" type="text/javascript" src="/order/order/Public/js/jquery-min.js"></script>
<script>

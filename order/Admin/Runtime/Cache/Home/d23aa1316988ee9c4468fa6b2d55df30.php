    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="dataTable_wrapper">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php if(is_array($list)): foreach($list as $k=>$data): ?><tr class="gradeA">
                                ...
                                <td>
                                    <a href="<?php echo U('infomanage/engineer_type_add',array('id'=>$data['id'],'edit_info'=>'查看信息'));?>">查看</a>
                                    <a href="<?php echo U('infomanage/engineer_type_add',array('id'=>$data['id'],'edit_info'=>'修改信息'));?>">修改</a>
                                    <a class="del-one" href="javascript:;" data="<?php echo U('infomanage/engineer_type_del',array('id'=>$data['id']));?>">删除</a>
                                </td>
                ...
                <div class="well">
                    <h4>
                        <a href="<?php echo U('infomanage/engineer_type_add',array('edit_info'=>'添加信息'));?>" class="addbt">新增</a>
                    </h4>
                </div>
            </div>
            <!-- /.panel-body -->

...
<input type="hidden" id="index_url" value="<?php echo U('customer/index');?>"/>
<!-- /.row -->
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <!-- /.panel-heading -->
            <form role="form" action="<?php echo U('customer/index');?>" method="POST" id="myForm1" enctype="multipart/form-data" data-ajax="false">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="grade" type="text" value="<?php echo ($data["grade"]); ?>">
                        </td>
                    </tr>
                    <tr>
                        <td class="col-name">门诊量</td>
                        <td>
                            <input name="outpatient" type="number" value="<?php echo ($data["outpatient"]); ?>">
                        </td>
                    </tr>
                    <tr>
                        <td class="col-name">床位数</td>
                        <td>
                            <input name="bednum" type="number" value="<?php echo ($data["bednum"]); ?>">
                        </td>
                    </tr>
                    <tr>
                ...
                'success':function(msg){
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="company">
                                <?php if(is_array($company_list)): foreach($company_list as $key=>$company): ?><option value="<?php echo ($company["name"]); ?>" <?php if($company['name'] == $data['company']): ?>selected<?php endif; ?>  ><?php echo ($company["name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div data-role="controlgroup" data-type="horizontal">
                                <label>
                                    未上线<input name="status" type="radio" value="0" <?php if($data['status'] == 0): ?>checked=true<?php endif; ?>>
                                </label>
                                <label>已上线<input name="status" type="radio" value="1" <?php if($data['status'] == 1 || $data['status'] == '' ): ?>checked=true<?php endif; ?>></label>
                            </div>
                        </td>
                    </tr>
                    <tr>

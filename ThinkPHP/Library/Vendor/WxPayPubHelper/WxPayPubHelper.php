...
class Common_util_pub
{
	...
	public $JS_API_CALL_URL = 'http://www.527dazhaxie.com/Home/Wxpay/index.html';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	public $NOTIFY_URL = 'http://www.527dazhaxie.com/Home/Wxpay/notify.html';
	...
	function __construct($config) {
		...
		if(isset($config['appid'])){
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
			$this->APPID = 'wx70a18f1a70ce9daa';
			//受理商ID，身份标识
			$this->MCHID = '1240608902';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = 'hxh1240608902a124060890215000897';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			$this->APPSECRET = '8872c07058e02c33c17bf9f2471d1e52';		
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径

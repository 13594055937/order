...
class Submit {
	...
	public function buildRequestForm($para_temp, $method, $button_name) {
		...
		$sHtml = $sHtml."<input type='submit'  value='".$button_name."' style='display:none;' id='aaa'></form>";
		$sHtml = $sHtml."<script>document.getElementById('alipaysubmit').submit();setTimeout(function(){location.reload();},1000) </script>";
